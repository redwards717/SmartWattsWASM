...
namespace SmartWatts.Server.DataAccess.SmartWattsDB
{
    public class ActivityAccess : IActivityAccess
    {
        ...
        {
            const string sql = @"INSERT INTO Activities(StravaRideID, StravaUserID, Name, Date, Type, HasWatts, MovingTime, Distance, AvgSpeed, MaxSpeed, AvgCadence, AvgWatts, WeightedAvgWatts, MaxWatts, Kilojoules, AvgHeartrate, MaxHeartrate)
                                    VALUES(@StravaRideID, @StravaUserID, @Name, @Date, @Type, @HasWatts, @MovingTime, @Distance, @AvgSpeed, @MaxSpeed, @AvgCadence, @AvgWatts, @WeightedAvgWatts, @MaxWatts, @Kilojoules, @AvgHeartrate, @MaxHeartrate)";
