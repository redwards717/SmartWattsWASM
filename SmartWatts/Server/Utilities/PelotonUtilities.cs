namespace SmartWatts.Server.Utilities
{
    ...
    {
        public static void AddMissingDataPoints(List<StravaDataStream> sdss)
        {
            ...
            wattsAry = correctedWatts.ToArray();
        }

        public static void AddMissingDataPointsWithCorrection(List<StravaDataStream> sdss, int percentAdj)
        {
            var wattsAry = sdss.Find(s => s.type == "watts").data;
            var timeAry = sdss.Find(s => s.type == "time").data;
